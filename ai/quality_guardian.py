...
from pipeline.reports import QUALITY_REPORT, save_report
...
_SYSTEM_PROMPT = (
    ...
    "Reply with plain prose only: no markdown headings, no bullet lists, no preamble — "
    "the text is rendered directly into a dashboard panel and a Slack message."
)
...
def run_quality_guardian():
    ...
    save_report(QUALITY_REPORT, report)
    return report
